...
pub async fn list(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.balancers)
...
pub async fn info(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.balancer)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
...
pub async fn preset_list(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.balancers_presets)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
