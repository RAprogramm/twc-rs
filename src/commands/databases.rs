...
pub async fn list(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.dbs)
...
pub async fn info(config: &Configuration, id: i32, format: OutputFormat) -> Result<(), TwcError> {
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.db)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
...
pub async fn backup_list(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.backups)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
...
pub async fn user_list(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.admins)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
...
pub async fn user_create(
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.admin)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
...
pub async fn preset_list(config: &Configuration, format: OutputFormat) -> Result<(), TwcError> {
    ...
    match format {
        ...
        OutputFormat::Json => {
            let json = serde_json::to_string_pretty(&resp.databases_presets)
                .map_err(|e| TwcError::Api(e.to_string()))?;
            println!("{json}");
        }
        OutputFormat::Quiet => {
